 ...
 */
abstract class BaseLiveDataUseCase<in P, R> {
...
operator fun <R> BaseLiveDataUseCase<Unit, R>.invoke(): LiveData<Result<R>> = this(Unit)
operator fun <R> BaseLiveDataUseCase<Unit, R>.invoke(result: MutableLiveData<Result<R>>) = this(Unit, result)
